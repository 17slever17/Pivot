...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.subscribeReviewRun]: AuthOrchestrationReadScope,
  [WS_METHODS.serverProbe]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetConfig]: AuthOrchestrationReadScope,
  [WS_METHODS.serverRefreshProviders]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpListLoginProviders]: AuthOrchestrationReadScope,
  [WS_METHODS.serverOmpLogin]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpGetSubagentMessages]: AuthOrchestrationReadScope,
  [WS_METHODS.serverOmpSteer]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpSetSubagentSubscription]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpCapabilitiesGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.serverOmpCapabilitiesWriteSetting]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpCapabilitiesResetSetting]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpCapabilitiesReadResource]: AuthOrchestrationReadScope,
  [WS_METHODS.serverOmpCapabilitiesWriteResource]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpCapabilitiesDeleteResource]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpCapabilitiesMoveItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverOmpAgentProfilesList]: AuthOrchestrationReadScope,
