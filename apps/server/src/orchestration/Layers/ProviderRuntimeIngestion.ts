        ...
        const status = (() => {
          switch (event.type) {
            ...
            case "session.exited":
              return "stopped";
            case "turn.aborted":
              // Settle the turn as interrupted (ProjectionPipeline maps this
              // session status onto still-running turns). Client phase treats
              // interrupted as idle-ready so the user can send again.
              return "interrupted";
            case "turn.completed":
