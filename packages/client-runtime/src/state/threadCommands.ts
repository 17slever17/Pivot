...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setAgentMode: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-agent-mode",
      execute: (input: SetThreadAgentModeInput) => setThreadAgentMode(input),
      scheduler,
      concurrency,
    }),
