...
# Sidebar native thread menu: language + archive + localized delete confirmation.
...
# Stop 250ms retry loops when subscribeThread definitively says the thread no longer exists.
...
# Translate well-known external Cursor system skill summaries without modifying their source files.
...
# Cover the generic retry predicate behavior.
...
# Small visual-audit strings missed because CSS uppercases their lowercase source text.
...
print("visual audit fixes applied")
